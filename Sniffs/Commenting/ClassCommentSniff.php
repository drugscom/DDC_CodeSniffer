...
if (class_exists('DDC_Sniffs_Commenting_FileCommentSniff', true) === false) {
    $error = 'Class DDC_Sniffs_Commenting_FileCommentSniff not found';
    throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class DDC_Sniffs_Commenting_ClassCommentSniff extends DDC_Sniffs_Commenting_FileCommentSniff
{
