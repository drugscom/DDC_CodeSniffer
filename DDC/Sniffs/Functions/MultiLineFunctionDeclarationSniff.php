 ...
 *
 * Based on the Squiz sniff, but allows no space before anonymous function parenthesis,
 * and no new line before closing parenthesis
 *
...
class MultiLineFunctionDeclarationSniff implements Sniff
{
	...
	public function process(File $phpcsFile, $stackPtr)
	{
		...
		if (strtolower($tokens[$stackPtr]['content']) === 'function') {
			...
			if ($spaces !== 'anonymous function' && $spaces !== 1) {
